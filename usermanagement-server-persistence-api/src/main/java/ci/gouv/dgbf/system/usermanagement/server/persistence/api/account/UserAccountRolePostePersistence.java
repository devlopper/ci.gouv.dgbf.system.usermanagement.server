...
public interface UserAccountRolePostePersistence extends PersistenceEntity<UserAccountRolePoste> {

	Collection<UserAccountRolePoste> readByUserAccount(UserAccount userAccount);
