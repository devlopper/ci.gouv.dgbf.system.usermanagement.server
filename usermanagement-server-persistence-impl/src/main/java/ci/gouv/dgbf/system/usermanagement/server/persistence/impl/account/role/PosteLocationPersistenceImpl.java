...
private String readWhereNameContains;
	...
	protected void __listenPostConstructPersistenceQueries__() {
		...
		addQueryCollectInstances(readWhereNameContains, "SELECT tuple FROM PosteLocation tuple WHERE lower(tuple.identifier) LIKE lower(:query) OR lower(tuple.type.name) LIKE lower(:query)");
	}
